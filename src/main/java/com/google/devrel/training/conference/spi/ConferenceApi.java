...
import com.google.devrel.training.conference.form.ConferenceQueryForm.Filter;
...
public class ConferenceApi {
    ...
    public Profile saveProfile(ProfileForm profform, User user) throws UnauthorizedException {
        ...
        teeShirtSize = profform.getTeeShirtSize() == null ? teeShirtSize : profform.getTeeShirtSize();
        // TODO 1
        // Set the displayName to the value sent by the ProfileForm, if sent
        // otherwise set it to null
        displayName = profform.getDisplayName() == "" ? null : profform.getDisplayName();
        // TODO 2
    ...
    public List<Conference> getConferencesCreated(User user) throws UnauthorizedException {
    	...
    	Query query = ofy().load().type(Profile.class).ancestor(profileKey);
    	return query.list();
    }
...
//    @ApiMethod(
//            name = "getConferencesFilteredSecond",
//            path = "getConferencesFilteredSecond",
//            httpMethod = HttpMethod.POST
//    )
//    public List<Conference> getConferencesFilteredSecond(){
//		Query query = ofy().load().type(Conference.class);
...
//	}
        ...
        WrappedBoolean result = ofy().transact(new Work<WrappedBoolean>() {
        	public WrappedBoolean run() { 
			        try {
			            ...
			            Key<Conference> conferenceKey = OfyService.factory().allocateId(Key.create(Profile.class, userId),Conference.class);
 ...
 /**
    ...
    public Collection<Conference> getConferencesToAttend(final User user)
        ...
        for(String websafeConferenceKey : keyStringsToAttend) {
        	conference.add(getConference(websafeConferenceKey));
        }
        
        return conference;  // change this
    }
